document.addEventListener('DOMContentLoaded', () => {
    ...
    */
    ...
    const introduction = (name, age, isStudent) => {
        ...
        if(isStudent = true){
            var studentStatus = "I am currently a student";
        }
        else {
    ...
    */
    ...
    document.querySelector("#add-classes").addEventListener('click', () => {
        ...
        document.querySelector('.selector-examples li:nth-child(2)').classList.add('even');
        ...
        document.querySelector('.selector-examples li:nth-child(6)').classList.add('last');
    });
